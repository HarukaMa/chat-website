/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: c63b90d11c4d7ce3e15b1a55fac519ae)
// Runtime types generated with workerd@1.20250730.0 2025-07-26 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PUBLIC_TWITCH_CLIENT_ID: "ijg6o5dv2nq9j6g4tcm6mx3p25twbz";
		PUBLIC_SESSION_DOMAIN: string;
		TWITCH_CLIENT_SECRET: string;
		DO: DurableObjectNamespace<import("../.svelte-kit/cloudflare/worker").DO>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_TWITCH_CLIENT_ID" | "PUBLIC_SESSION_DOMAIN" | "TWITCH_CLIENT_SECRET">> {}
}
